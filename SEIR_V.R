...
y = covidSEIRsR %>%
  simulate(params=params_guess, nsim=2000, format="data.frame")
...
bake(file=paste(cache_address,"/local_search_simple_V.rds", sep = ''),{
...
bake(file=paste(cache_address,"/lik_local_simple_V.rds", sep = ''),{
...
#run global search}
bake(file=paste(cache_address,"/global_search_simple_VY.rds", sep = ''),{
